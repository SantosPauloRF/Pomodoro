...
description: >-
  ...
  skill local, ou globais de código/UI). Use proactively when the user
...
1. Ler `AGENTS.md` e `PLANEJAMENTO.md` na raiz deste repo.
...
5. Se for deste app: atualizar `AGENTS.md` (bloco “Decisões” e/ou Changelog) e/ou `PLANEJAMENTO.md` e/ou a skill `produto-pomodoro` / criar skill nova + linha em `Skills.md`.
